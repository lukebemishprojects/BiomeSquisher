...
public class TestLayoutReloadListener implements ResourceManagerReloadListener {
    public static final ResourceLocation LOCATION = new ResourceLocation("biomesquisher", "test_layout");
