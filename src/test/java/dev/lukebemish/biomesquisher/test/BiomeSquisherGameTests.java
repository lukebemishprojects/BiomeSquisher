...
public class BiomeSquisherGameTests {
    ...
    private MultiNoiseBiomeSource getOverworldBiomeList(Level level, ResourceManager resourceManager) {
        ...
        BiomeSquisherMod.squishBiomeSource(resourceManager, null, source, LevelStem.OVERWORLD, level.registryAccess());
        return source;
    }
}
