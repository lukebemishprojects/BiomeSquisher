...
public sealed interface DimensionBehaviour {
    BiMap<Type, MapCodec<? extends DimensionBehaviour>> TYPE_MAP = ImmutableBiMap.<Type, MapCodec<? extends DimensionBehaviour>>builder()
    ...
    MapCodec<? extends DimensionBehaviour> codec();
    ...
    final class Range implements DimensionBehaviour {
        public static final MapCodec<Range> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
        ...
        @Override
        public MapCodec<? extends DimensionBehaviour> codec() {
            return CODEC;
        }
    ...
    final class Squish implements DimensionBehaviour {
        public static final MapCodec<Squish> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
