...
public record Squisher(Injection injection, Holder<Biome> biome, Relative relative, boolean snap) {
    public static final Codec<Squisher> CODEC = RecordCodecBuilder.create(i -> i.group(
        ...
        Relative.CODEC.optionalFieldOf("relative", Relative.DEFAULT).forGetter(Squisher::relative),
